...
class StorageService:
    def __init__(self):
        ...
        self.endpoint_url = "http://localhost:9000" # MinIO default or from settings
        self.aws_access_key_id = "admin"
        self.aws_secret_access_key = "password123"
        self.bucket_name = "mesa-law-docs"
