...
class LegalSource(Base, AuditMixin):
    ...
    status: Mapped[LegalSourceStatus] = mapped_column(
        SQLEnum(LegalSourceStatus, name="legal_source_status", create_type=False),
        default=LegalSourceStatus.CURRENT,
        nullable=False,
    )
