...
export default function GlobalReviewsPage() {
  ...
  const { data: reviewsResponse, isLoading } = useListDraftReviewsApiV1ReviewsGet()
  ...
  return (
    <div className="max-w-7xl mx-auto p-8 lg:p-12">
      <div className="mb-12">
        <h1 className="text-4xl font-bold tracking-tight text-[var(--foreground)] mb-2">Global Review Center</h1>
        <p className="text-[var(--color-anthracite-400)]">Review pending AI extractions, claims, and timeline events across all matters.</p>
      </div>
      ...
      {reviews.length === 0 ? (
        <div className="glass-card p-12 text-center rounded-2xl">
          ...
          <p className="text-[var(--color-anthracite-400)]">No pending reviews require your attention.</p>
        </div>
      ) : (
            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm text-[var(--color-anthracite-400)]">Matter ID: {review.matter_id}</span>
                </div>
