...
export default function MatterResearchPage() {
  ...
  return <UnavailableFeature title={t('researchTitle')} description={t('researchDescription')} action={<Link href={localizedHref(locale, '/matters')} className={buttonVariants({ variant: 'outline' })}>{t('backToMatters')}</Link>} />
}
