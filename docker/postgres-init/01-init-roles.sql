...
ALTER DEFAULT PRIVILEGES FOR ROLE mesa_law_migrator IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO mesa_law_app;
ALTER DEFAULT PRIVILEGES FOR ROLE mesa_law_migrator IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO mesa_law_worker;
ALTER DEFAULT PRIVILEGES FOR ROLE mesa_law_migrator IN SCHEMA public GRANT USAGE, SELECT, UPDATE ON SEQUENCES TO mesa_law_app;
ALTER DEFAULT PRIVILEGES FOR ROLE mesa_law_migrator IN SCHEMA public GRANT USAGE, SELECT, UPDATE ON SEQUENCES TO mesa_law_worker;
